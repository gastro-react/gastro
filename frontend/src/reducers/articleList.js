  ...
  switch (action.type) {
    ...
    case HOME_PAGE_LOADED:
      return {
        ...
        articles: action.payload ? (action.payload[1] ? action.payload[1].articles : []):null,
        articlesCount: action.payload ? (action.payload[1] ? action.payload[1].articlesCount : 0):null,
        currentPage: 0,
        tab: action.tab
      };
